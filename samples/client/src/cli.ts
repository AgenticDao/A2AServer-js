...
const serverUrl = process.argv[2] || "http://localhost:12001";
...
function printAgentEvent(
  event: TaskStatusUpdateEvent | TaskArtifactUpdateEvent | null
) {
  if (!event) {
    console.log(colorize("yellow", "Received null event"));
    return;
  }
