 ...
 * @returns The current timestamp as a string in ISO 8601 format (YYYY-MM-DDTHH:mm:ss.sssZ).
 */
 ...
 * Used for type validation throughout the codebase.
 ...
 * Used to differentiate yielded updates from the handler when processing
 * incremental task state changes.
 * @param update The update object to check.
 * @returns True if the object conforms to the TaskStatus structure.
 */
 ...
 * Used to differentiate yielded updates from the handler when processing
 * artifact generation or modifications.
 * @param update The update object to check.
 * @returns True if the object conforms to the Artifact structure.
 */
